        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:block">
            <div className="ml-10 flex items-baseline space-x-8">
              ...
              <Link href="/auth" className="bg-blue-600 text-white hover:bg-blue-700 px-4 py-2 rounded-lg text-sm font-medium transition-colors">
                Sign In
              </Link>
            </div>
          </div>
        ...
        {isMenuOpen && (
          <div className="md:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-white border-t">
              ...
              <Link href="/#features" className="text-gray-500 hover:text-blue-600 block px-3 py-2 text-base font-medium">
                Features
              </Link>
              <Link href="/#how-it-works" className="text-gray-500 hover:text-blue-600 block px-3 py-2 text-base font-medium">
                How it Works
              </Link>
              <Link href="/auth" className="bg-blue-600 text-white hover:bg-blue-700 block px-3 py-2 rounded-lg text-base font-medium">
                Sign In
              </Link>
            </div>
          </div>
