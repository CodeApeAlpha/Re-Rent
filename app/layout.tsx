...
export const metadata: Metadata = {
  title: 'Re-Rent - Vehicle Rental Platform',
  description: 'Connect vehicle owners with renters. Earn money from your idle car or find the perfect vehicle for your needs.',
  themeColor: '#2563eb',
